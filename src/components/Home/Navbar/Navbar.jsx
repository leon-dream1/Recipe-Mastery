      ...
      <div className="container mx-auto mt-2">
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-[32px] text-[#150B2B] font-bold">
              Recipe Mastery
            </a>
          </div>
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1 space-x-12">
              <li className="text-[#150B2BB2] text-[16px] font-normal">Home</li>
              <li>Recipe</li>
              <li>About</li>
              <li>Search</li>
            </ul>
          ...
          <div className="navbar-end space-x-4">
            <label className="input rounded-[50px] flex items-center gap-3 bg-[#150B2B0D] outline-offset-0 border-0 outline-0">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
                fill="currentColor"
