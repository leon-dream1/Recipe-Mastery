...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    document.querySelector("html").setAttribute("data-theme", existTheme);
  }, [theme]);
        ...
        <div className="navbar">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              >
                ...
                <li className="text-[16px] font-normal cursor-pointer">
                  Recipe
                </li>
                <li className="text-[16px] font-normal cursor-pointer">
                  About
            ...
            <a className="text-[20px] lg:text-[32px]  font-bold">
              Recipe Mastery
            </a>
          </div>
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1 space-x-12">
              ...
              <li className="text-[16px] font-normal cursor-pointer">Search</li>
            </ul>
          </div>
