        ...
        <div className="navbar">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex="0"
                className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 space-y-3 lg:space-y-0"
              >
                <li className="text-[#150B2BB2] text-[16px] font-normal cursor-pointer">
                  Home
                </li>
                <li className="text-[#150B2BB2] text-[16px] font-normal cursor-pointer">
                  Recipe
            ...
            <a className="text-[20px] lg:text-[32px] text-[#150B2B] font-bold">
              Recipe Mastery
            </a>
          </div>
          ...
          <div className="navbar-end space-x-2 lg:space-x-4">
            <label className="input rounded-[50px] lg:flex items-center gap-3 bg-[#150B2B0D] outline-offset-0 border-0 outline-0 hidden">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
                fill="currentColor"
